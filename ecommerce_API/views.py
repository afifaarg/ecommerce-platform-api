...
from .models import Newsletter, Product, Order, ProductInOrder, User
from .serializers import NewsletterSerializer, ProductSerializer, OrderSerializer, UserSerializer
